...
- Test baseline: run `cargo test --all-targets -- --test-threads=1`; the 2026-08-19 verification passed 671 unit tests, ignored 11 (including the Linux PTY Ctrl+C manual-QA case), plus 1 external integration smoke test. Zero clippy warnings (strict).
