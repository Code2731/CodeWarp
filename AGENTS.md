...
- Test baseline: run `cargo test --all-targets -- --test-threads=1`; the 2026-08-18 verification passed 640 unit tests, ignored 11 (including the Windows/Linux PTY Ctrl+C manual-QA cases), plus 1 external integration smoke test. Zero clippy warnings (strict).
