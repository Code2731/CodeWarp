...
- [x] **Tests** — 회고적 + TDD 누적 104 tests (보안/마이그레이션/순수 helpers/format coupling/엔진 명령 합성/모델 scan/Display 분기/regenerate truncate/Apply 파서)
- [ ] Phase 2-10 — PTY 터미널, MCP 통합
- [ ] P4-2 — @-mention 파일/심볼 컨텍스트
- [ ] P4-5 — Drag & drop 파일 → 컨텍스트
- [ ] **embedded inference** — `mistral.rs` 임베드 검토 (외부 도구 없이 GGUF 직접 로드)
