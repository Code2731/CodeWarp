...
- Bounded input paths: provider REST/SSE, local `/v1/models`, and Hugging Face metadata/error responses are capped at 4 MiB, attachments at 512 KiB, MCP config and session auxiliary state at 1 MiB, and workspace tool reads at 1 MiB
