...
mod update_inference_lifecycle_control;
mod update_inference_spawn;
mod update_inference_tabby;
mod update_inference_tabby_fetch;
mod update_settings;
mod update_settings_hf;
mod update_settings_interact_attachment;
mod update_settings_interact_attachment_read;
mod update_settings_interact_pty;
