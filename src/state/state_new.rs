...
impl App {
    ...
    pub(crate) fn new() -> (Self, Task<Message>) {
        ...
        let mut app = Self {
            ...
            mcp_request_generation: 0,
            mcp_pending_results: 0,
            mcp_pending_call_ids: std::collections::HashSet::new(),
            ...
            generation_lookup_generation: 0,
            ...
            hovered_code_blocks: std::collections::HashSet::new(),
            hovered_block: None,
            hovered_session: None,
            hovered_context_idx: None,
            hovered_settings_tab: None,
            hovered_palette_idx: None,
            hovered_confirm_idx: None,
            ...
            mcp_tool_load_generations: std::collections::HashMap::new(),
            mcp_tools: Vec::new(),
