use crate::view::ui::{
    FS_BODY, FS_CAPTION, FS_LABEL, FS_SUBTITLE, SPACE_XS, danger_btn, field_input, panel_style,
    primary_btn, secondary_btn, section_header, semibold_font, sub_panel_style,
};
